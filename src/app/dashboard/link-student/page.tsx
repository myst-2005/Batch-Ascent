...
import { Link as LinkIcon, CheckCircle, UserPlus, Users, Building, Phone, Mail, User, Monitor, MapPin, Filter, BookOpen, ArrowRight, ArrowLeft } from 'lucide-react'
    ...
    const fetchMetadata = async () => {
        try {
            ...
            const { data: batchData } = await supabase
                .from('batches')
                .select('id, name, mode, school, course, start_date')
            ...
            <div className="card">
                {success ? (
                    <div className="animate-scale-in" style={{ textAlign: 'center', padding: '2rem 1rem' }}>
                        <div style={{ margin: '0 auto 1rem', width: '4rem', height: '4rem', background: '#d1fae5', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                        ...
                        {generatedId && generatedId !== 'ID Generated' && (
                            <div style={{ background: 'white', border: '2px dashed #86efac', borderRadius: 'var(--radius-lg)', padding: '1.5rem', marginBottom: '2rem', display: 'inline-block' }}>
                                <div style={{ fontSize: '0.875rem', color: '#16a34a', fontWeight: '600', textTransform: 'uppercase', marginBottom: '0.25rem' }}>Student ID</div>
                                <div style={{ fontSize: '1.875rem', fontFamily: 'monospace', fontWeight: 'bold', color: '#15803d' }}>{generatedId}</div>
                            </div>
                        )}
                    ...
                    <>
                        <div style={{ marginBottom: '1.5rem', paddingBottom: '1rem', borderBottom: '1px solid var(--border)' }}>
                            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1rem' }}>
                                ...
                                <button
                                    onClick={() => router.push('/dashboard/link-student/bulk')}
                                    className="btn"
                                    style={{
