...
import { Link as LinkIcon, CheckCircle, Upload, Plus, Trash, ArrowRight, ArrowLeft } from 'lucide-react'
...
export default function BulkLinkStudentPage() {
    ...
    const fetchMetadata = async () => {
        const { data: batchData } = await supabase
            .from('batches')
            .select('id, name, mode, school, course')
